      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-xl p-4 shadow-lg border border-slate-700">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <select 
              className="px-4 py-2 rounded-lg border border-slate-600 bg-slate-800 text-white text-sm h-10 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 min-w-[140px]"
            ...
            {/* View Toggle */}
            <div className="flex border border-slate-600 rounded-lg bg-slate-800 ml-2">
              <Button
