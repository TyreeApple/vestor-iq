...
const MaintenancePage = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-lg p-2 shadow-lg border border-slate-700">
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className="pl-7 h-7 bg-slate-800 border-slate-600 text-white placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500 text-xs"
              value={search}
          ...
          <div className="flex gap-1.5">
            <select 
              className="px-2 py-1 rounded border border-slate-600 bg-slate-800 text-white text-xs h-6 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 flex-1 min-w-0"
            ...
            <AdvancedFilters
              ...
              triggerProps={{
                size: "sm",
                className: "bg-slate-700 border-slate-600 text-white hover:bg-slate-600 hover:text-white h-6 px-2 text-xs"
              }}
            />

            {/* View Toggle */}
            <div className="flex border border-slate-600 rounded bg-slate-800">
              <Button
